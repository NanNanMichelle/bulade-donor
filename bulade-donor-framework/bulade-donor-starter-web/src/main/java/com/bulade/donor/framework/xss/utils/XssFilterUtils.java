...
public class XssFilterUtils {
     ...
     */
    private static final Safelist WITH_IMAGES = Safelist.basicWithImages();
    ...
    static {
        ...
        // 所以需要给所有标签添加style属性
        WITH_IMAGES.addAttributes(":all", "style");
    }

    public static String clean(String content) {
        content = Jsoup.clean(content, "", WITH_IMAGES, OUTPUT_SETTINGS);
