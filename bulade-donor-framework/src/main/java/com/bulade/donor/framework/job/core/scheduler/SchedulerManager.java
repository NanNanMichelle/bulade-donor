package com.bulade.donor.framework.job.core.scheduler;
...
import com.bulade.donor.framework.job.core.handler.JobHandlerInvoker;
import org.quartz.*;
...
public class SchedulerManager {
    ...
    private void validateScheduler() {
        if (scheduler == null) {
            throw BusinessException.of(ResultCodeEnum.UNKNOWN);
        }
    }
