package com.bulade.donor.framework.biz.operatelog.core.aop;
...
public class OperateLogAspect {
    ...
    public Object around(ProceedingJoinPoint joinPoint,
                         com.bulade.donor.framework.biz.operatelog.core.annotations.OperateLog operateLog)
        throws Throwable {
    ...
    private void log(ProceedingJoinPoint joinPoint, OperateLog operateLog, Operation operation,
        ...
        try {
            ...
            // 真正记录操作日志
            var operateLogObj = new com.bulade.donor.framework.biz.operatelog.core.service.OperateLog();
